...
class CTkWindow(customtkinter.CTk):
    def __init__(self,
                 ...
                 style="classic"  # style, classic or modern
                 ):
        ...
        self.header = customtkinter.CTkFrame(self, corner_radius=round_corner, fg_color=self.titlebar_color,
                                             ...
                                             transparent_color, transparent_color, None, None))
        ...
        self.ctkimage = customtkinter.CTkImage(Image.open(
